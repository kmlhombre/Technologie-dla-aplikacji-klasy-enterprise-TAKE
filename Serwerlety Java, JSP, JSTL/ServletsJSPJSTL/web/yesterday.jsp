...
<html>
    ...
    <body>
        ...
        <p>
        Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="default"/><br/>
        Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="short"/><br/>
        Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="medium"/><br/>
        Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="long"/><br/>
        Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="full"/><br/>
        </p>
